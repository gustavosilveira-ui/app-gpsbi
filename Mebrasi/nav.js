/* ================================================================
   Hub GPSBI · Grupo Mebrasi — Navegação compartilhada
   ================================================================ */
const APP_PAGES = [
...
function renderAppNav({ activePage, userLabel, userRole, onLogout, sb, currentUser }){
  ...
  const theme = savedInAccount || localStorage.getItem('mebrasi_theme') || 'light';
  ...
  if(savedInAccount) localStorage.setItem('mebrasi_theme', theme); // mantém o cache local sincronizado
