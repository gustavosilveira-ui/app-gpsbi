/* ================================================================
   Hub GPSBI · Jambuzada — Navegação compartilhada
   ================================================================ */
const APP_PAGES = [
...
function appApplyTheme(t, skipSync){
  ...
  localStorage.setItem('jambuzada_theme', t);
...
function renderAppNav({ activePage, userLabel, userRole, onLogout, sb, currentUser }){
  ...
  if(savedInAccount) localStorage.setItem('jambuzada_theme', theme); // mantém o cache local sincronizado
